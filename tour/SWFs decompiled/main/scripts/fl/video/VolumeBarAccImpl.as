package fl.video
{
   ...
   public class VolumeBarAccImpl extends AccessibilityImplementation
   {
      ...
      {
         var _loc2_:String = "";
         if(Boolean(param1 == 0 && this.master.accessibilityProperties) && Boolean(this.master.accessibilityProperties.name) && this.master.accessibilityProperties.name != "")
         {
      ...
      override public function accLocation(param1:uint) : *
      {
         ...
         if(Boolean(_loc5_[_loc6_.fullness_mc].mask_mc))
         {
      ...
      override public function accDoDefaultAction(param1:uint) : void
      {
         ...
         var _loc4_:Number = _loc3_ ? Math.round(_loc2_.cachedSoundLevel * 1000) / 100 : Math.round(this._vc.volume * 1000) / 100;
         if(param1 == 1)
         {
