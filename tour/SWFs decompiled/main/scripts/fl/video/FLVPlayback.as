package fl.video
{
   ...
   public class FLVPlayback extends Sprite
   {
      ...
      public function FLVPlayback()
      {
         ...
         if(Boolean(this.boundingBox_mc))
         {
      ...
      flvplayback_internal function handleVideoEvent(param1:fl.video.VideoEvent) : void
      {
         ...
         var _loc2_:VideoPlayerState = this.videoPlayerStateDict[param1.currentTarget];
         var _loc3_:CuePointManager = this.cuePointMgrs[_loc2_.index];
         var _loc4_:fl.video.VideoEvent = VideoEvent(param1.clone());
         _loc4_.vp = _loc2_.index;
         ...
         switch(param1.type)
         {
            case VideoEvent.AUTO_REWOUND:
               dispatchEvent(_loc4_);
               dispatchEvent(new fl.video.VideoEvent(VideoEvent.REWIND,false,false,_loc5_,param1.playheadTime,_loc2_.index));
            ...
            case VideoEvent.PLAYHEAD_UPDATE:
               ...
               if(!isNaN(_loc2_.preSeekTime) && param1.state != VideoState.SEEKING)
               {
                  ...
                  _loc3_.resetASCuePointIndex(param1.playheadTime);
                  dispatchEvent(new fl.video.VideoEvent(VideoEvent.SEEKED,false,false,param1.state,param1.playheadTime,_loc2_.index));
                  if(_loc6_ < param1.playheadTime)
                  {
                     dispatchEvent(new fl.video.VideoEvent(VideoEvent.FAST_FORWARD,false,false,param1.state,param1.playheadTime,_loc2_.index));
                  }
                  else if(_loc6_ > param1.playheadTime)
                  {
                     dispatchEvent(new fl.video.VideoEvent(VideoEvent.REWIND,false,false,param1.state,param1.playheadTime,_loc2_.index));
                  }
               }
            ...
            case VideoEvent.STATE_CHANGE:
               ...
               switch(param1.state)
               {
                  case VideoState.BUFFERING:
                     dispatchEvent(new fl.video.VideoEvent(VideoEvent.BUFFERING_STATE_ENTERED,false,false,_loc5_,param1.playheadTime,_loc2_.index));
                     break;
                  case VideoState.PAUSED:
                     dispatchEvent(new fl.video.VideoEvent(VideoEvent.PAUSED_STATE_ENTERED,false,false,_loc5_,param1.playheadTime,_loc2_.index));
                     break;
                  case VideoState.PLAYING:
                     dispatchEvent(new fl.video.VideoEvent(VideoEvent.PLAYING_STATE_ENTERED,false,false,_loc5_,param1.playheadTime,_loc2_.index));
                     break;
                  case VideoState.STOPPED:
                     dispatchEvent(new fl.video.VideoEvent(VideoEvent.STOPPED_STATE_ENTERED,false,false,_loc5_,param1.playheadTime,_loc2_.index));
               }
               break;
      ...
      public function set visibleVideoPlayerIndex(param1:uint) : void
      {
         ...
         this.uiMgr.handleIVPEvent(new fl.video.VideoEvent(VideoEvent.STATE_CHANGE,false,false,this.state,this.playheadTime,this._visibleVP));
         this.uiMgr.handleIVPEvent(new fl.video.VideoEvent(VideoEvent.PLAYHEAD_UPDATE,false,false,this.state,this.playheadTime,this._visibleVP));
         if(_loc2_.isRTMP)
         {
            this.uiMgr.handleIVPEvent(new fl.video.VideoEvent(VideoEvent.READY,false,false,this.state,this.playheadTime,this._visibleVP));
         }
         else
         {
      ...
      flvplayback_internal function _scrubStart() : void
      {
         ...
         this._volume = _loc2_.volume;
         _loc2_.volume = 0;
         dispatchEvent(new fl.video.VideoEvent(VideoEvent.STATE_CHANGE,false,false,VideoState.SEEKING,_loc1_,this._visibleVP));
         dispatchEvent(new fl.video.VideoEvent(VideoEvent.SCRUB_START,false,false,VideoState.SEEKING,_loc1_,this._visibleVP));
      }
      ...
      flvplayback_internal function _scrubFinish() : void
      {
         ...
         {
            dispatchEvent(new fl.video.VideoEvent(VideoEvent.STATE_CHANGE,false,false,_loc2_,_loc1_,this._visibleVP));
         }
         dispatchEvent(new fl.video.VideoEvent(VideoEvent.SCRUB_FINISH,false,false,_loc2_,_loc1_,this._visibleVP));
      }
      ...
      flvplayback_internal function skinLoaded() : void
      {
         ...
         dispatchEvent(new fl.video.VideoEvent(VideoEvent.SKIN_LOADED,false,false,this.state,this.playheadTime,this._visibleVP));
      }
      ...
      public function assignTabIndexes(param1:int) : int
      {
         ...
         return this.uiMgr.assignTabIndexes(param1);
      }
      ...
      {
         if(Boolean(this.uiMgr.startTabIndex))
         {
