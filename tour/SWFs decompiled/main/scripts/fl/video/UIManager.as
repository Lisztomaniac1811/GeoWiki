   ...
   public class UIManager
   {
      ...
      flvplayback_internal function handleLayoutEvent(param1:LayoutEvent) : void
      {
         ...
         if(this._fullScreen && this._fullScreenTakeOver && this._fullScreenAccel && this._vc.stage != null)
         {
            ...
            _loc2_ = int(this._vc.activeVideoPlayerIndex);
      ...
      flvplayback_internal function handleIVPEvent(param1:IVPEvent) : void
      {
         ...
         switch(param1.type)
         {
            case VideoEvent.STATE_CHANGE:
               ...
               {
                  this._progressPercent = this._vc.getVideoPlayer(param1.vp).isRTMP ? 100 : 0;
                  _loc3_ = SEEK_BAR;
            ...
            case VideoProgressEvent.PROGRESS:
               ...
               this._progressPercent = _loc7_.bytesTotal <= 0 ? 100 : _loc7_.bytesLoaded / _loc7_.bytesTotal * 100;
      ...
      public function set skinBackgroundColor(param1:uint) : void
      {
         if(this.borderColor != param1)
         {
            ...
            this.borderColorTransform.redOffset = this.borderColor >> 16 & 0xFF;
            this.borderColorTransform.greenOffset = this.borderColor >> 8 & 0xFF;
            this.borderColorTransform.blueOffset = this.borderColor & 0xFF;
            this.borderPrevRect = null;
            this.layoutSkin();
         }
      }
      ...
      flvplayback_internal function addButtonControl(param1:Sprite) : void
      {
         ...
         var _loc3_:int = int(this._vc.activeVideoPlayerIndex);
         this._vc.activeVideoPlayerIndex = this._vc.visibleVideoPlayerIndex;
      ...
      flvplayback_internal function handleLoad(param1:Event) : void
      {
         ...
         try
         {
            ...
            while(i < this.layout_mc.numChildren)
            {
               ...
               index = Number(layoutNameToIndexMappings[dispObj.name]);
               if(!isNaN(index))
               {
      ...
      flvplayback_internal function layoutSkin() : void
      {
         ...
         video_mc = this.layout_mc["video_mc"];
         if(video_mc == null)
         {
         ...
         try
         {
            ...
            {
               minWidth = Number(this.layout_mc["minWidth"]);
         ...
         try
         {
            ...
            {
               minHeight = Number(this.layout_mc["minHeight"]);
         ...
         switch(_loc2_.index)
         {
            ...
            case VOLUME_BAR:
               ...
               if(_loc2_.progress_mc != null)
               {
                  ...
                  {
                     this._progressPercent = this._vc.isRTMP ? 100 : 0;
                  }
      ...
      flvplayback_internal function setCustomClip(param1:DisplayObject) : void
      {
         ...
         if(dispObj.name == "border_mc")
         {
            ...
            try
            {
               this.borderCopy = Boolean(ctrlData.avatar["colorMe"]) ? new Sprite() : null;
            }
            catch(re:ReferenceError)
            {
               borderCopy = null;
      ...
      flvplayback_internal function positionHandle(param1:Sprite) : void
      {
         ...
         var _loc5_:Number = isNaN(_loc2_.origWidth) ? param1.width : _loc2_.origWidth;
      ...
      {
         var _loc2_:int = int(this._vc.activeVideoPlayerIndex);
         this._vc.activeVideoPlayerIndex = this._vc.visibleVideoPlayerIndex;
         if(param1 == SEEK_BAR)
         {
      ...
      flvplayback_internal function doBufferingDelay(param1:TimerEvent) : void
      {
         ...
         if(this._vc.state == VideoState.BUFFERING)
         {
            ...
            this.handleIVPEvent(new fl.video.VideoEvent(VideoEvent.STATE_CHANGE,false,false,VideoState.BUFFERING,NaN,this._vc.visibleVideoPlayerIndex));
         }
         this._vc.activeVideoPlayerIndex = _loc2_;
      }
         ...
         if(!this._fullScreen && this._vc.stage != null)
         {
            if(this._fullScreenTakeOver)
            {
               try
               {
                  ...
                  effectiveMinWidth = int(this.fullScreenSourceRectMinWidth);
                  effectiveMinHeight = int(this.fullScreenSourceRectMinHeight);
      ...
      flvplayback_internal function exitFullScreenTakeOver() : void
      {
         ...
         try
         {
            ...
            cacheActiveIndex = int(this._vc.activeVideoPlayerIndex);
            i = 0;
            while(i < this._vc.videoPlayers.length)
            {
               vp = this._vc.videoPlayers[i] as VideoPlayer;
               if(vp != null)
               {
                  ...
                  if(Boolean(this.cacheFLVPlaybackAlign[i]))
                  {
      ...
      flvplayback_internal function handleKeyEvent(param1:KeyboardEvent) : void
      {
               ...
               switch(event.target)
               {
                  ...
                  case this.controls[VOLUME_BAR_HANDLE]:
                     ...
                     if(event.target != this.controls[SEEK_BAR_HANDLE])
                     {
                        ...
                        num = this._isMuted ? Math.round(this.cachedSoundLevel * 1000) / 100 : Math.round(this._vc.volume * 1000) / 100;
                     ...
                     try
                     {
                        ...
                        if(Boolean(nextCuePoint) && this._vc.isFLVCuePointEnabled(nextCuePoint))
                        {
         ...
         if(focusControl != null)
         {
            ...
            else
            {
               ...
               {
                  if(Boolean(param1.target.visible))
                  {
                     ctrlData.state = NORMAL_STATE;
            ...
            while(i < doc.numChildren)
            {
               try
               {
                  ...
                  if(child != null && child != this._vc && child is classReference)
                  {
                     ...
                     if(Boolean(c.focusManager.showFocusIndicator))
                     {
                        return false;
                     }
                     break;
