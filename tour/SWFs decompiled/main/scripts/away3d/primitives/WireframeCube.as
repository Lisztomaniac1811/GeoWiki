package away3d.primitives
{
   ...
   public class WireframeCube extends WireframePrimitiveBase
   {
      ...
      public function WireframeCube(width:Number = 100, height:Number = 100, depth:Number = 100, color:uint = 16777215, thickness:Number = 1)
      {
      ...
      override protected function buildGeometry() : void
      {
         ...
         var hh:Number = this._height * 0.5;
         var hd:Number = this._depth * 0.5;
         v0.x = -hw;
         v0.y = hh;
         v0.z = -hd;
         v1.x = -hw;
