package caurina.transitions
{
   public class TweenListObj
   {
      ...
      public function toString() : String
      {
         ...
         if(Boolean(this.skipUpdates))
         {
            returnStr += ", skipUpdates:" + String(this.skipUpdates);
         }
         if(Boolean(this.updatesSkipped))
         {
